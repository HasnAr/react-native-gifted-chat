...
import { Linking, StyleSheet, Text, View, ViewPropTypes, TouchableOpacity } from 'react-native';
  ...
  render() {
    ...
    return (
      <View style={[styles[this.props.position].container, this.props.containerStyle[this.props.position]]}>
        <TouchableOpacity onPress={this.onPlaySound}>
          <Text style={{ color: 'red' }}>play me</Text>
        </TouchableOpacity>
        {/* <ParsedText
          style={[
